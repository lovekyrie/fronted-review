...
- [Day 1 JS 数据类型 / this / 原型链](./day1-js-foundation-checklist)
- [Day 2 闭包 / 作用域 / ES6](./day2-closure-scope-es6)
- [Day 3 异步与事件循环](./day3-async-event-loop)
- [Day 4 DOM / BOM / 事件机制](./day4-dom-bom-event)
- [Day 5 内存管理与浏览器渲染](./day5-memory-browser-render)
- [Day 6 HTTP / 缓存 / 跨域 / 存储](./day6-http-cache-cross-origin)
- [Day 7 基础模拟面 1](./day7-basic-mock-1)
- [Day 8 HTML/CSS 高频布局](./day8-html-css-layout)
- [Day 9 语义化 / 兼容性 / 动画](./day9-semantic-compat-animation)
